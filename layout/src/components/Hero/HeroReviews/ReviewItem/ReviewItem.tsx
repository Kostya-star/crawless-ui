...
export const ReviewItem = ({ ind }: ReviewItemProps) => {
  return (
    <li className="col-2__review-item review-item">
      {ind === 0 ? (
      ...
      <p className="review-item__text">
        Additional custom attributes Note that the actor doesn't support special
        types of Google searches, such as Google Shopping, Google Images or
        Google News.
      </p>
    </li>
  );
